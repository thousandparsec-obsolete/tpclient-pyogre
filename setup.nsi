...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Thousand Parsec\Client pyogre"
...
OutFile tpclient-pyogre-${VERSION}-setup.exe
InstallDir "$PROGRAMFILES\Thousand Parsec\tpclient-pyogre"
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion 0.0.1.0
VIAddVersionKey ProductName tpclient-pyogre
