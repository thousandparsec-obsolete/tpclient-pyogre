# Console code from cradle (python-ogre forums)
# http://wiki.python-ogre.org/index.php/CodeSnippets_Ingame_Console
...
class Console(ogre.FrameListener):
	CONSOLE_LINE_LENGTH = 160
	CONSOLE_LINE_COUNT = 30
	__shared_state = {}
